...
-- -----------------------------------------------------
-- Table `mydb`.`INSTRUMENT_CATEGORY`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`INSTRUMENT_CATEGORY` ;

CREATE TABLE IF NOT EXISTS `mydb`.`INSTRUMENT_CATEGORY` (
...
-- -----------------------------------------------------
-- Table `mydb`.`INSTRUMENT_MODEL`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`INSTRUMENT_MODEL` ;

CREATE TABLE IF NOT EXISTS `mydb`.`INSTRUMENT_MODEL` (
  `IM_ID` INT NOT NULL,
  `Name` VARCHAR(255) NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`INSTRUMENT_TYPES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`INSTRUMENT_TYPES` ;

CREATE TABLE IF NOT EXISTS `mydb`.`INSTRUMENT_TYPES` (
  ...
  CONSTRAINT `fk_INSTRUMENT TYPES_INSTRUMENT CATEGORY1`
    ...
    REFERENCES `mydb`.`INSTRUMENT_CATEGORY` (`IC_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `mydb`.`INSTRUMENT` (
  ...
  CONSTRAINT `fk_INSTRUMENT_INSTRUMENT MODEL1`
    ...
    REFERENCES `mydb`.`INSTRUMENT_MODEL` (`IM_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_INSTRUMENT_INSTRUMENT TYPES1`
    FOREIGN KEY (`INSTRUMENT TYPES_IT_ID`)
    REFERENCES `mydb`.`INSTRUMENT_TYPES` (`IT_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
